...
//----------------------------------------------------------------------------------
bool scl::Wow64QueryInformationProcess64(
    HANDLE hProcess,
    ...
    PULONG ReturnLength)
{
    ...
    if (_NtWow64QueryInformationProcess64 == nullptr)
        return false;
...
//----------------------------------------------------------------------------------
bool scl::Wow64ReadProcessMemory64(
    HANDLE hProcess,
    PVOID64 address,
    PVOID buffer,
...
//----------------------------------------------------------------------------------
bool scl::Wow64WriteProcessMemory64(
    HANDLE hProcess,
    PVOID64 address,
    LPCVOID buffer,
    ULONGLONG buffer_size,
